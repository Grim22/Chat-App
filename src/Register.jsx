    ...
    <div className="form-container h-[100vh] flex items-center justify-center">
        <div className="form-wrapper flex flex-col items-center bg-base-300 p-12 gap-5 rounded-xl">
            ...
            <form action="" onSubmit={handleSubmit} className="flex flex-col gap-5">
                <input type="text" placeholder='display name' className="input" required/>
                ...
                <label htmlFor="file" className="flex items-center justify-around gap-5 cursor-pointer" >
                    <p className="text-sm">Upload Image (required)</p>
                    <svg class="w-[29px] h-[29px] text-primary" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
